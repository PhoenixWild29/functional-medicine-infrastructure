...
**Main branch:** commit `ab29457` (2026-07-08) — through PR #107. Doc refresh (#101–#104) + R9 corrections (#105) + Sign & Send provider gating (#106) + dependabot #97 + LOW backlog fixes (#107) all merged. Phase C multi-Rx groups live; F-3/F-5 role features shipped; V3 catalog live in prod (verified by R9).
