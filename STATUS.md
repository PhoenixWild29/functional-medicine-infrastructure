...
**Main branch:** commit `c9d79c1` (2026-07-02) — Jun-14 batch (#89–#95) + orphan-cron removal (#96) all merged. Phase C (multi-Rx groups) live with flag ON; F-3 opt-in toggle, F-5 primary provider, dispute fan-out, PHI debug table (flag OFF) all deployed.
