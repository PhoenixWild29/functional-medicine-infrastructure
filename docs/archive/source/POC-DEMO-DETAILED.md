...
**Version:** 2.22 | **Date:** September 18, 2026
...
54. **Point out** the sign page: patient info, provider info, prescription details, financial summary (**v2.20:** with a **Shipping** line — **$22.00** on the Semaglutide draft, **$0.00** on the Testosterone Cypionate draft because the two ship together — and a **Patient total**), signature pad. Note the send control starts disabled with the hint **"Sign in the signature box above to enable sending"** underneath it.
...
60. **Watch the drawer flip in place — do not close it.** The moment Combine succeeds, the solo **"Copy Payment Link"** block disappears and is replaced, in the same open drawer, by the **"Part of a Payment Bundle"** panel showing the prescription count and bundle total (**"2 prescriptions · $308.00"** — v2.20: $286.00 of prescriptions plus $22.00 Strive shipping, charged once) with a **"Copy Bundle Payment Link"** button. The dashboard rows behind the drawer update immediately too. One bundled checkout link covering both prescriptions is now on your clipboard — Semaglutide $190.00 + Testosterone Cypionate $96.00 + $22.00 shipping; the **$190.00** assumes the **2×** tap, it defaults to $133.00. This is the link you'll paste in Part 4.
